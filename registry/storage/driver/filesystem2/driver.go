...
func fromParametersImpl(parameters map[string]interface{}) (*DriverParameters, error) {
	...
	if parameters != nil {
		...
		if tmpBaseUrl, ok := parameters["baseurl"]; ok {
			baseUrl = fmt.Sprint(tmpBaseUrl)
		}
...
func New(params DriverParameters) *Driver {
	fsDriver := &driver{rootDirectory: params.RootDirectory, baseUrl: params.BaseUrl}
